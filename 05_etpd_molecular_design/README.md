...
| JHA-84 | `competitor_pipeline_pattern_analysis.md` | 2(High) |
...
- JHA-85: 5장 서술과 `00_legacy_unsorted/GD_TED_report.md` Section E. **Gate G4 프레임 문서(deck_architecture_and_scoring_framework.md)는 repo에 포함하지 않기로 했다**(docs/DECISIONS_260924.md). 평가축(epitope 독립성, FTO/특허, engineerability, differentiation)은 이 폴더에서 자체 정의한다.
